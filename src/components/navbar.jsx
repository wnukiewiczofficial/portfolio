...
import { HiUser, HiClipboardList, HiCode, HiChatAlt, HiChevronDoubleUp } from "react-icons/hi";
...
export default function NavBar({ cardRef, contentRef, navPopRef }) {
	...
	return (
		<>
			...
			{/* desktop */}
			<animated.nav style={navPop} className="hidden lg:flex py-4 px-8 h-auto rounded-2xl bg-themeTwo transition duration-200">
